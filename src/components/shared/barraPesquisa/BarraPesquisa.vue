<template>
  <div class="painel-barra-pesquisa">
    <v-row class="painel-titulos-autocomplete">
      ...
      <v-col>
        <p class="titulo-autocomplete" v-show="tipoFiltroSelecionado">{{ tipoFiltroSelecionado }}</p>
      </v-col>
      <v-col></v-col>
    </v-row>  
...
export default {
  ...
  methods: {
    ...
    async pesquisarPaises() {
      ...
      switch (this.tipoFiltroSelecionado) {
        ...
        case "Capital":
          url = "https://restcountries.eu/rest/v2/capital/" + arg + filtros;
          break;
        ...
        case "Língua":
          ...
          url =
            "https://restcountries.eu/rest/v2/lang/" + idioma_iso3691 + filtros;
          break;
        ...
        case "País":
          ...
          url =
            "https://restcountries.eu/rest/v2/alpha/" + codigoPais + filtros;
          break;

        case "Código de ligação":
          url = "https://restcountries.eu/rest/v2/callingcode/" + arg + filtros;
          break;
      }
  ...
  created() {
    ...
    let url =
      "https://restcountries.eu/rest/v2/all?fields=name;capital;languages;callingCodes;alpha3Code;translations";
...
.autocomplete_filtro-enter, .autocomplete_filtro-leave-active {
  opacity: 0;
}
